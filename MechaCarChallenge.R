...
# testing total_summary dataframe
total_summary
...
#2. Use the t.test() function three times and its subset() argument to determine if the PSI for each manufacturing lot is statistically different from the population mean of 1,500 pounds per square inch.
